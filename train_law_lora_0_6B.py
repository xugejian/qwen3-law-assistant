...
test_dataset_path = os.path.join(script_path, "val_law.jsonl")

train_jsonl_new_path = os.path.join(script_path, "train_format_law.jsonl")
test_jsonl_new_path = os.path.join(script_path, "val_format_law.jsonl")
...
args = TrainingArguments(
    output_dir="./output/Qwen3-0.6B-lora-cuda",
...
# 开始训练，若中途停止，可通过 resume_from_checkpoint 继续训练
# trainer.train()
